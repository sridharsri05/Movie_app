...
//   return (
//     <article className="relative border-0">
//       <Link to={link}>
//         <div className="max-w-sm rounded overflow-hidden group">
//           <div className="relative overflow-hidden rounded-md h-60 sm:h-72 md:h-[19rem] lg:h-[20rem] 3xl:h-96">
//             <img
...
const Card = ({ title, poster, year, rating, link }) => {
  return (
    <article className="relative border-0 flex justify-center items-center mt-2">
      <Link to={link}>
