...
//   return (
//     <>
//       <div className="relative w-full p-4 bg-gray-800 min-h-screen mt-7">
...
//                         </span>
//                       </h3>
//                       <p className="text-sm sm:text-base   text-yellow-400 mt-1">
//                         ⭐ {movie?.imdbRating}
//                       </p>
...
const SearchResults = () => {
  ...
  return (
    <>
      <div className="relative w-full l:p-2 md:p-6 bg-gray-800 min-h-screen mt-[4rem]">
        <div className="pl-2 mb-3 text-xl text-white border-l-4 border-yellow-500 font-libre">
          Results found : {query}
        </div>
        {isLoading ? (
                ...
                >
                  ...
                  >
                    ...
                    <div className="ml-4 flex flex-col justify-between w-full">
                      ...
                      <p className="text-sm text-gray-300 mt-2 line-clamp-2 sm:line-clamp-3">
                        {movie?.Genre || "No description available."}
                      </p>
                      <p className="text-sm text-gray-300 mt-2 line-clamp-2 sm:line-clamp-3">
                        {movie?.Plot || "No description available."}
