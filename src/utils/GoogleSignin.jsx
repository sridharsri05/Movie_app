...
const GoogleSignin = () => {
  ...
  return (
    <div className="flex place-content-center mt-1">
      <button
        className="flex items-center bg-white text-blue-700 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text--white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
